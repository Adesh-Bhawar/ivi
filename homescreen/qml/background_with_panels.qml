...
Window {
    ...
    // Reduce bar height in landscape so app area gets more space
    property int barSize: isLandscape ? 120 : 216
    ...
    Grid {
            ...
            Image {
                ...
                RowLayout {
                    ...
                    ShortcutArea {
                        ...
                        Layout.preferredWidth: background.isLandscape
                                               ? parent.width * 0.75
                                               : 775
                    }
                    StatusArea {
        ...
        Rectangle {
            width: Screen.width
            height: Screen.height - (2 * background.barSize)
            Image {
                anchors.fill: parent
